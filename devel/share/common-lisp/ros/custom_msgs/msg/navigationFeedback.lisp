...
(cl:defmethod cl:initialize-instance :after ((m <navigationFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'navigationFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<navigationFeedback> is deprecated: use custom_msgs-msg:navigationFeedback instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <navigationFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msgs-msg:sequence-val is deprecated.  Use custom_msgs-msg:sequence instead.")
  (sequence m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<navigationFeedback>)))
  ...
  "custom_msgs/navigationFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'navigationFeedback)))
  "Returns string type for a message object of type 'navigationFeedback"
  "custom_msgs/navigationFeedback")
